  ...
  const policies = [
    {
      ...
      content: <>We accept returns within <span className="font-semibold text-amber-800 bg-amber-50 px-2 py-0.5 rounded">2 days</span> of delivery. Items must be unused, unsealed, and in original packaging. Unsealed perfumes cannot be returned for hygiene reasons.</>
    },
    {
