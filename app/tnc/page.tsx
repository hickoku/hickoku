...
export default function TermsAndConditionsPage() {
  const termsSections = [
    {
      ...
      content:
        "Hickoku operates from Maharashtra, India. By accessing our website or purchasing our products, you agree to these Terms & Conditions. All brand content including logo, product names, packaging, and website material are exclusive property of Hickoku. Unauthorized use is prohibited.",
    },
    {
      icon: <Box className="w-6 h-6 text-amber-600" />,
      title: "Product Nature & Pricing",
      content:
        "Hickoku products are concentrated alcohol-free attar perfume oils. Natural variations in scent or color may occur. All prices are in INR (₹). Products comply with the Legal Metrology Rules, 2011. The printed MRP is inclusive of all applicable taxes.",
    },
    {
      icon: <CreditCard className="w-6 h-6 text-amber-600" />,
      title: "Orders & Payment",
      content:
        "Orders are confirmed only after successful payment. Hickoku reserves the right to cancel orders due to stock issues, pricing errors, or suspected fraud. Refunds (if applicable) are processed within 5–7 business days.",
    },
    {
      icon: <RefreshCcw className="w-6 h-6 text-amber-600" />,
      title: "Returns & Refunds",
      content:
        "Due to hygiene and personal use nature, opened products cannot be returned. Damaged or incorrect items must be reported within 24 hours with proof. Approved refunds/replacements are processed within 7–10 business days.",
    },
    {
      icon: <AlertTriangle className="w-6 h-6 text-amber-600" />,
      title: "Skin Sensitivity & Liability",
      content:
        "Attars are highly concentrated oils. Patch test recommended. Discontinue use if irritation occurs. Hickoku is not responsible for allergic reactions. Liability is strictly limited to the purchase value of the product.",
    },
    {
      icon: <Gavel className="w-6 h-6 text-amber-600" />,
      title: "Governing Law",
      content:
        "These Terms are governed by Indian law. Jurisdiction: Maharashtra, India. By utilizing our platform, you implicitly agree to resolve disputes within the state boundaries of our operations.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 overflow-hidden relative selection:bg-amber-500/20">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 relative z-10">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
        ...
        >
          ...
          >
            ...
            or purchasing our premium fragrances. Your access is conditioned
            upon accepting these policies.
          </motion.p>
          <motion.p
            variants={fadeUpVariant}
            className="text-xs text-amber-600/60 mt-4 font-mono"
          >
