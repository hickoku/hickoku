...
export default function AboutUsPage() {
  const sections = [
    ...
    },
    {
      ...
      description:
        "We believe fragrance is an extension of self. Our creations are designed to sit close to the skin, evolving gently throughout the day without overpowering the senses. Hickoku fragrances are crafted to feel natural, expressive, and timeless.",
      delay: 0.2,
    },
  ];
    ...
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 overflow-hidden relative selection:bg-amber-500/20">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-24 relative z-10">
        ...
        >
          ...
          >
            Hickoku Perfume is a contemporary fragrance brand dedicated to
            crafting scents that speak to emotion, memory, and individuality.
            Each creation is designed to blend seamlessly into everyday life
