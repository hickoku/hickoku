    ...
    },
    {
      ...
      content: (
        <div className="flex gap-4 mt-2">
          <a
            href="#"
            className="p-2 bg-amber-50 rounded-full text-amber-700 hover:bg-amber-100 hover:scale-110 transition-all duration-300"
          >
    ...
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 overflow-hidden relative selection:bg-amber-500/20">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-24 relative z-10">
        ...
        >
          ...
          >
            Have a question, need help with an order, or looking for fragrance
            advice? Reach out and our team will get back to you as soon as
            possible.
          </motion.p>
        </motion.div>
