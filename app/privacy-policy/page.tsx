  ...
  const privacySections = [
    {
      ...
      content:
        "We collect information you provide directly to us when making a purchase, such as your name, billing address, shipping address, payment information, email address, and phone number. We also automatically collect certain device information using cookies to enhance your browsing experience.",
    },
    {
      icon: <Server className="w-6 h-6 text-amber-600" />,
      title: "How We Use Your Data",
      content:
        "Your data is primarily used to fulfill your orders, process payments securely through our partner Razorpay, arrange for shipping, and provide you with invoices or order confirmations. We additionally use data to screen for potential risk or fraud.",
    },
    {
      icon: <ShieldClose className="w-6 h-6 text-amber-600" />,
      title: "Data Sharing & Third Parties",
      content:
        "We share your personal information exclusively with trusted third parties to help us fulfill your orders (e.g. delivery partners, payment gateways). We do not sell or rent your personal information to marketing agencies or unauthorized third parties.",
    },
    {
      icon: <UserCheck className="w-6 h-6 text-amber-600" />,
      title: "Your Rights & Retention",
      content:
        "When you place an order, we will maintain your Order Information for our records unless you ask us to delete this information. You hold the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted.",
    },
  ];
    ...
    <div className="min-h-screen bg-[#FAFAFA] text-gray-900 overflow-hidden relative selection:bg-amber-500/20">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 relative z-10">
        ...
        >
          ...
          >
            Your privacy is our priority. Discover exactly how we collect, use,
            and securely shield your personal information while you interact
            with Hickoku.
          </motion.p>
          <motion.p
            variants={fadeUpVariant}
